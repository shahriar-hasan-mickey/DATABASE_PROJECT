...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 27, 2020 at 01:50 AM
...
(2, 1, 'Raj Kachori', 'Raj Kachori', '325195312_raj-kachori.jpeg', 'veg', 1, '2020-06-17 10:46:06'),
...
(9, 4, 'Full', 400, 1, '2020-06-27 12:50:50');
...
-- Error reading data for table online_food.order_status: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM `online_food`.`order_status`' at line 1
...
(1, 'Vishal', 'ervishalwebdeveloper@gmail.com', '99999999', '$2y$10$tUJYvfDXmrpL.WQwgB/WZOv69m6G3B/r1HzM1y.fDnn4dnS9d4ZSa', 1, 1, 'mkgzxqptfsbwiga', '2020-06-25 12:29:38');
